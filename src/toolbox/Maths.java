...
public class Maths
{
    ...
    public static Matrix4f createViewMatrix(Camera camera)
    {
        ...
        Matrix4f.rotate((float)Math.toRadians(camera.getPitch()), new Vector3f(1.0F, 0.0F, 0.0F), viewMatrix, viewMatrix);
        Matrix4f.rotate((float)Math.toRadians(camera.getYaw()), new Vector3f(0.0F, 1.0F, 0.0F), viewMatrix, viewMatrix);
